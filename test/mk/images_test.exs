defmodule Mk.ImagesTest do
  ...
  describe "images" do
    ...
    import Mk.ImagesFixtures

    @invalid_attrs %{image_path: nil, product_id: nil}
    ...
    test "create_image/1 with valid data creates a image" do
      valid_attrs = %{image_path: "some image_path", product_id: "some product_id"}

      assert {:ok, %Image{} = image} = Images.create_image(valid_attrs)
      assert image.image_path == "some image_path"
      assert image.product_id == "some product_id"
    end
    ...
    test "update_image/2 with valid data updates the image" do
      ...
      assert image.product_id == "some updated product_id"
    end
